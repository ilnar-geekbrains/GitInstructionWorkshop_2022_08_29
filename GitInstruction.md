...
Ветвления нужны для того чтобы отработать отдельный *Тестовый* участок работы. И удостоверившись в его работоспособности, перенести его в основной проект.
...
Что бы просмотреть имеющиеся ветки нужно ввести команду:

    git branch

### Перемещенние между ветками

Для перемещения между ветками нужно ввеси команду:

    git checkout имя_ветки

### Слияние веток

Для того что бы слить ветки нужно находясь в ветке в которую хотите слить другую ветку, ввеси команду:

    git merge имя_ветки

### Удаление веток

Что бы удалить ненужную ветку нужно добавить ключ -d:
