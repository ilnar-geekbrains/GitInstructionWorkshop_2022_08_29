...
1. Чтобы создать ветку надо написать git branch branch_name
2. Чтобы посмотреть список веток написать git branch
3. Чтобы перемещаться между ветками написать git checkout branch_name
4. Чтобы связать ветки написать git merge branch_name
