...
> Git clone - копирует репозиторий с Github

> cd - помещает нас в сам склоннированный репозиторий

> git pull - стягивает изменения, которые были внесены на Github и автоматические делает merge с нашей версией
...
1. Делаем аккаунт на Github  
2. Создать локальный репозиторий  
3. "Подружить" свой локальный репозиторий и удалённый. Github при создании нового репозитория подскажет как это можно сделать.  
4. Отправить (push) свой локальный репозиторий в удалённый, при этом, возможно, нужно будет авторизоваться на удалённом репозитории.
5. Провести изменения "с удалённого компьютера"  
