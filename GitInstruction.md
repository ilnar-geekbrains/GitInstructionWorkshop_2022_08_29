...
Как правило, совместная работа ведется в одном удаленном репозитории, доступ к которому и право вносить изменения имеют ограниченное количество человек. Чтобы внести свой вклад в такой проект, нужно скопировать в свой аккаунт чужой репозиторий на github через кнопку fork. На вашем аккаунте появится копия чужого репозитория. Скопируйте ссылку на свою копию этого репозитория и склонируйте этот репозиторий себе на компьютер (git clone). Создайте новую ветку и работайте в ней. Сохраните изменения и закомитьте их. Сделайте git push в репозиторий на вашем аккаунте. Оттуда через кнопку pull requests можно предложить свои изменения модераторам чужого проекта. Они уже решат, принимать их или отклонить. 
