...
Удаленный репозиторий - это удаленное хранилище данных. В нем можно хранить свои репозитории, доступ к которым может иметь группа пользователей. Удобно для работы в команде и для работы с разных мест.
