...
Работать удаленно с репозитарием можно с помощью GitHub. Для этого нам необходимо создать аккаунт на данном портале, создать удаленный репозитарий. Если что портал дает полезные подсказки. 
Затем перейдя на портале в репозитарий мы можем скопировать три строчки и вставить в терминал в VSC. 
Вот пример строчек:
