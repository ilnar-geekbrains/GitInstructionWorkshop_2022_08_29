...
Репозиторий - папка на локальном компьютере или онлайн сервисе (например github), содержащая наш проект.
Для создания репозитория, создаем локальную папку и инициализируем ее в гите, командой **git init**
