...
Чтобы скачать репозиторий себе, нужно выполнить в папке, не являющейся репозиторием, команду _git clone_.

Работу с репозиторием можно продолжить у себя на компьютере. Далее, чтобы внести изменения в удалённый репозиторий, нужно выполнить команду _git push_. Помимо этого нужно быть авторизованным на _GitHub_ в среде разработки.

Чтобы вытянуть изменения из удалённого репозитория на локальный компьютер, нужно выполнить команду _git pull_.

Чтобы загрузить локальный репозиторий на _GitHub_, нужно создать пустой репозиторий в своём аккаунте и выполнить предложенные команды.
