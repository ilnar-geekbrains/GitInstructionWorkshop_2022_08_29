...
Ветки позволяют вести работу над кодом, не внося изменения в основную версию, а так же для организации параллельной работы нескольких людей над одним проектом.
