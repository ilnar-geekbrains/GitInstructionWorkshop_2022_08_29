...
Чтобы не вносить ошибочных изменений в основную версию проекта
...
Для хранения данных на сервере, к которому мы можем подключиться из любой точки мира и с любого устройства
...
Для возможности нескольких разрабов работать над одним проектом, ничем при этом не рискуя 
