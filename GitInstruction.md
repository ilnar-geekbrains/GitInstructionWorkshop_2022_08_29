...
Для просмотра веток введите команду
```
git branch
```
Чтобы перейти на ветку введите команду
```
git checkout 'branch_name'
```
Удалить ветку
```
git branch 'branch_name' -d или (-D)
```
Слияние веток, нужно перейти в ветку к которой будет происходить слияние
```
