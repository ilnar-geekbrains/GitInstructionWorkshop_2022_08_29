...
Удалённые репозитории — это модификации проекта, которые хранятся в интернете или ещё где-то в сети. Их может быть несколько, каждый из которых как правило доступен либо только на чтение, либо на чтение и запись.

Нужен для совместной работы над проектом, сохранения различных версий и возврата к ним в любой момент.
