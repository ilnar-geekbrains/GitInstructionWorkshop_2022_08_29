...
Чтобы распределить блоки проекта между отдельными программистами, при этом так, что несколько программистов могут одновременно работать над общими блоками.
Каждому программисту создаётся его ветка, в которой он сохраняет комиты своих изменений.
На определённом этапе, после тестирования и получения кода, годового к запуску в проекте, архитектор или техлид совмещает все версии разработанных блоков кода в главной ветке.
Главная ветка сохраняет основные изменения уже готового кода.
Вспомогательные ветки отдельных программистов используются как черновики отдельных блоков проекта.
