...
Просто сделать ветку, не переключаясь на нее можно командой _**git branch <имя ветки>**_. 

Переключиться на ветку - _**git checkout <имя ветки>**_.

Объединить ветку с какой-то другой веткой - _**git merge**_.
Что бы смержить одну ветку в другую нужно вначале переключиться на ту ветку, в которую вы хотите смержить _**git checkout <имя ветки>**_.

Потом получить последние изменения сделанные в этой ветке выполнив _**git pull**_.

Затем выполнить команду _**git merge <имя ветки>**_.
