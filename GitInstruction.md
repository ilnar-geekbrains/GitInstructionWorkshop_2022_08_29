...
Чтобы создать локальный репозиторий, нужно:
1. Создать папку на вашем компьютере.
2. Убедиться, что вы сейчас находитесь в нужной папке.
3. Ввести в терминале git init.
