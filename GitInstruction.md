...
1. * Скачать **[git](https://git-scm.com/)** , установить его на ПК следуя инструкции.
    * Скачать **[VScode](https://code.visualstudio.com/)** , установить его на ПК следуя инструкции.
2. Запустить VScode
3. Создать папку и зайти в нее через VScode
4. Открыть терминал **ctrl+`**
5. Прописать **git status**
6. ......
7. Вы великолепны
