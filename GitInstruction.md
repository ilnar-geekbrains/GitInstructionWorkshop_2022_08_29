...
>Для того чтобы создать новую ветку используйте команду *git branch <имя новой ветки>*
>Для того чтобы создать и перейти на новую ветку используйте команду *git checkout -b <имя новой ветки>*
