...
Для обзора веток в репозитории необходимо набрать команду *git branch.* Для создания новой ветки необходимо набрать команду *git branch name_new_branch.* И для переключения между существующими ветками репозитория необходимо набрать команду *git checkout name_branch.*
