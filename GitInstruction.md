...
При первоначальном запуске программы git необходимо выполнить две команды настройки, настройки имени пользователя и электронной почты пользователя. Без этих настроек программа работа не будет.

**git config -- global [user.name](http://user.name) “your_name”**

**git config - - global [user.email](http://user.email) “your email@gmail.com”**
